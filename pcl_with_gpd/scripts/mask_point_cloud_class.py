...
def roi_cut(color_image,depth_image, pt1:tuple=(0,0),pt2:tuple=(1280,720)):
    ...
    return color_image, depth_image,pt1
...
if __name__ == "__main__":
    ...
    try:
        for i in range(num_views):
            ...
            # color_image,depth_image=roi_cut(color_image,depth_image,pt1=(230,10),pt2=(1040,700))
        ...
        # 顯示點雲和座標系
        geometries_to_draw = [vpc.o3d_pcd for vpc in view_point_cloud_list] + [axis]
