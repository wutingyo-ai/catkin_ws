...
def main():
    # monitor(targetP1)
    go_to_position(SetPositionsRequest.PTP_T,targetP1,30,1,0) 
    # monitor(targetP2)
    go_to_position(SetPositionsRequest.PTP_T,targetP2,30,1,100)
    # monitor(targetP3)
    go_to_position(SetPositionsRequest.PTP_T,targetP3,30,1,0)
