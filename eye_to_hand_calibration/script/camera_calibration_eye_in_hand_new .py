...
# 存儲轉移矩陣的列表
transformation_matrices_flange2Base = []
transformation_matrices_flange2Base_Rotation = []
transformation_matrices_flange2Base_Translation = []
...
for index, column in data_subset.iterrows():
    ...
    # 將轉移矩陣添加到列表中
    transformation_matrices_flange2Base_Rotation.append(rotation)
    transformation_matrices_flange2Base_Translation.append(translation) 
    transformation_matrices_flange2Base.append(T)
...
R_cam2base,t_cam2base=cv.calibrateHandEye(
                                                R_gripper2base = transformation_matrices_flange2Base_Rotation,
                                                t_gripper2base = transformation_matrices_flange2Base_Translation,
