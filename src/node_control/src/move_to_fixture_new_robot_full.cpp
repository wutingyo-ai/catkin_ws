...
{   
  ...
  while (ros::ok())//總程式迴圈
  {
    ...
    while(ros::ok()) //////////////////////////////////////////////////放置之轉接製具之運動//////////////////////////////////     //第一階段運動 //
    {
      ...
      double listener_pose_y_err=0.6092;

      
      //visual_tools.prompt("Press 'next' to ready1");
      gripper(pub_gripper, 180);//發布指夾行程為180
      //點位1,目標物體上,姿態由topic訂閱
      double TCPts1[6] = {listener.pose_x, listener.pose_y+listener_pose_y_err, 100, -180.00, listener.pose_Ry,  listener.pose_Rz}; //100為TCP'11081'高度100mm
      string P1 = Poi2Str_trajectory(TCPts1,speed,200,trajectory_percent);
      ...
      double TCPts2[6] = {listener.pose_x, listener.pose_y+listener_pose_y_err, 29, -180.00, listener.pose_Ry, listener.pose_Rz};// z=29
      string P2 = Poi2Str_absolute(TCPts2,absolute_speed,200,trajectory_percent);
      srv.request.script = P2;
      client.call(srv);
      point_detect(0.15248); //0.15832
      ...
      // 點位3,將物體抬起
      double TCPts3[6] = {listener.pose_x, listener.pose_y+listener_pose_y_err, 140, -180.00, listener.pose_Ry, listener.pose_Rz};
      string P3 = Poi2Str_trajectory(TCPts3,speed,200,trajectory_percent);
      srv.request.script = P3;
      client.call(srv);
      point_detect(0.26443); //0.26443

      // visual_tools.prompt("Press 'next' next");

      //120 0.24350   45 0.16849   44 0.16749 revise

      if ((chooseOption(listener.ACCC) == choices::Option::Reverse) && (listener.pose_Ry == 45))//第3次
      {
        //OK4 但不好校正
        //gripper11081 //第一個插槽點位參數資訊
        double place_Rx1 =56.70;                         //55.65; 2024_10_08
        double place_Ry1 =-482.95;                       //-483.40; 2024_10_08
        ...
        double up_place1[6] = {place_Rx1+errx , place_Ry1, 120, Rev_placeRx1, Rev_placeRy1, Rev_placeRz1}; //到須放置之插槽上面
        string place_Rev1 = Poi2Str_trajectory(up_place1,speed,200,trajectory_percent);
        srv.request.script = place_Rev1;
        client.call(srv);
        point_detect(0.24379);//0.24379

        double med_pt[6] = {place_Rx1+errx , place_Ry1, 42, Rev_placeRx1, Rev_placeRy1, Rev_placeRz1}; //離插槽很近之上方點位
        string mediapt = Poi2Str_absolute(med_pt,absolute_speed,200,trajectory_percent);
        ...
        string place_Rev2 = Poi2Str_absolute(place_down1,absolute_speed,200,trajectory_percent);
        ...
        double place_ok1[6] = {place_Rx1+errx, place_Ry1, 120, Rev_placeRx1, Rev_placeRy1, Rev_placeRz1}; //回到初始place_ok1點位 
        string place_Rev3 = Poi2Str_trajectory(place_ok1,speed,200,trajectory_percent);
      ...
      else if ((chooseOption(listener.ACCC) == choices::Option::Reverse) && (listener.pose_Ry == -45))//第2次
      {
        ...
        //gripper11081 
        // 0424 有問題  
        double place_Rx2 = 57.00;                         //56.43; 2024_10_08
        double place_Ry2 = -483.20;                       //-483.17; 2024_10_08// 原始-482.43 2024/08/22
        ...
        //Pallet的x向量有微小誤差
        double errx = 0.3; //0.25 2024_10_08
        ...
        string place_Rev4 = Poi2Str_trajectory(up_place2,speed,200,trajectory_percent);
        ...
        string place_Rev5 = Poi2Str_absolute(place_down2,absolute_speed,200,trajectory_percent);
        ...
        string place_Rev6 = Poi2Str_trajectory(place_ok2,speed,200,trajectory_percent);
      ...
      //gripper11081
      //Place1       
        double place_Fx1 = 56.30;            //56.09; 2024_10_08
        double place_Fy1 = -482.95;                //-483.05;2024_10_08// 2024/08/22    原始-483.55
        ...
        string place_Fnt1 = Poi2Str_trajectory(up_place3,speed,200,trajectory_percent);
        ...
        string place_Fnt2 = Poi2Str_absolute(place_down3,absolute_speed,200,trajectory_percent);
        ...
        string place_Fnt3 = Poi2Str_trajectory(place_ok3,speed,200,trajectory_percent);
        srv.request.script = place_Fnt3;
        client.call(srv);
        point_detect(0.24350);
      ...
      { 
        ...
        // gripper11081 
        // Place1       
        double place_Fx2 = 56.85;          //56.60; 2024_10_08
        double place_Fy2 = -482.90;          //-482.80; 2024_10_08 //原始-481.96 2024/08/22
        ...
        string place_Fnt4 = Poi2Str_trajectory(up_place4,speed,200,trajectory_percent);
        ...
        string place_Fnt5 = Poi2Str_absolute(place_down4,absolute_speed,200,trajectory_percent);
        ...
        string place_Fnt6 = Poi2Str_trajectory(place_ok4,speed,200,trajectory_percent);
...
////////////////////////////////////////////////////////////////////////////
        // 退出前快速回到拍照點位
      double GO_to_Photo[6] = {0.38, -555.01, 75.40, -178.93, -0.81, 92.30}; //75.40為TCP'11081'高度75.40mm
      string P_photo = Poi2StrPTP_trajectory(GO_to_Photo,speed,200,trajectory_percent);
      srv.request.script = P_photo; // 定義命令
      client.call(srv); //呼叫請求點位的命令
      pose_detect(0.00374, -0.55735, 0.25000);//檢查有無到法蘭面座標拍攝的位置
////////////////////////////////////////////////////////////////////////////
      leave.request.script = cmd;
